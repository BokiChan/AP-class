...
public class DrawingLoop implements Runnable{
    ...
    public void run() {
        while(running){
            ...
            checkDrawCollisions(gameStage.getGameCharacterMario());
            checkDrawCollisions(gameStage.getGameCharacterrockman());
            paint(gameStage.getGameCharacterMario());
            paint(gameStage.getGameCharacterrockman());
