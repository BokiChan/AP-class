...
public class GameLoop implements Runnable {
    ...
    private void update(GameCharacter gameCharacter) {
        ...
        if(leftPressed && rightPressed){
            ...
            gameStage.getGameCharacterMario().trace();
            gameStage.getGameCharacterrockman().trace();
    ...
    public void run() {
        while (running) {
            ...
            update(gameStage.getGameCharacterMario());
            update(gameStage.getGameCharacterrockman());
